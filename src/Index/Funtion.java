...
public class Funtion {
    ...
    DatosJson datos = Conexion.api();

    double value1;
    double value2;

    public void print(String send, String search){
        System.out.println("""
                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                """ + send + """
                \s --->\s""" + search + """
  ...
  public double convert(String send, String search, double monto){
        value1 = datos.conversion_rates().get(search);
        value2 = datos.conversion_rates().get(send);
        return (value1/value2)*monto;
  }

  public void answer(double monto, String send, double convertir, String search){
      DecimalFormat decimal = new DecimalFormat();
      System.out.println(monto + " " + send + " Equivale a un aproximado de: " + decimal.format(convertir) + " "+ search);
  }

  //Extra: Ampliar el rango de monedas a convertir
    ...
    public void monedas(){
        System.out.println( """
                  ...
                  ZWL	          Zimbabwean Dollar	         Zimbabwe\s
                """);
    }
}
